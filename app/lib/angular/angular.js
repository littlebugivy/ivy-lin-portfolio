 ...
 * portfolio.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://portfolio.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://portfolio.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('portfolio', []).config(function($sceDelegateProvider) {
 ...
 *        'http://portfolio.example.com/clickThru**']);
 *      });
 * </pre>
 */
 ...
 * @example
 <example module="mySceApp">
  <file name="index.html">
    <div ng-controller="portfolioController as myCtrl">
  ...
  <file name="script.js">
    ...
    mySceApp.controller("portfolioController", function portfolioController($http, $templateCache, $sce) {
      var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('portfolioWithSceDisabledportfolio', []).config(function($sceProvider) {
